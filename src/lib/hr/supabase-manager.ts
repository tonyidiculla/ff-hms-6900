    ...
    const client = createClient(supabaseUrl, supabaseAnonKey, {
      ...
      global: {
        headers: {
          ...
          'X-Service-Purpose': 'hr-management',
          'X-HMS-Priority': '5',
  ...
  private setupDebugMonitoring(): void {
    ...
    console.warn = (...args: any[]) => {
      ...
      if (message.includes('Multiple GoTrueClient instances detected')) {
        ...
        originalWarn('📊 Current active clients:', this.getActiveClients());
        originalWarn('📈 Client count:', this.getClientCount());
        originalWarn('💡 This should not happen with the client manager active');
        console.groupEnd();
      } else {
...
// ff-hrms-6860 specific client with proper isolation
