...
export const financeNavigation: NavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      { name: 'Chat Channels', href: 'http://localhost:6900/chat' },
      { name: 'Messages', href: 'http://localhost:6900/chat/messages' },
      { name: 'Create Channel', href: 'http://localhost:6900/chat/create' },
    ],
  },
  {
    name: 'HR',
