  ...
  const modules = [
    {
      ...
      description: 'Diagnostic tests and lab analysis',
      features: [
        { name: 'Lab Tests', href: '/diagnostics/lab', icon: '🔬', color: 'blue', description: 'Diagnostic lab tests and results' },
      ]
    },
  ];
    ...
    <ContentArea>
      <VStack size="sm">
        <div className="flex items-baseline gap-3">
          <h1 className="text-3xl font-bold text-slate-800">Diagnostics Services</h1>
          <p className="text-sm text-slate-500">Comprehensive diagnostic and laboratory services</p>
        </div>
            ...
            <CardContent className="py-3 px-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-2">Pending Tests</p>
                </div>
            ...
            <CardContent className="py-3 px-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-2">Completed Today</p>
                </div>
            ...
            <CardContent className="py-3 px-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-2">Urgent Tests</p>
                </div>
